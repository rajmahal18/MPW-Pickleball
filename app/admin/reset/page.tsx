...
const scopes = [
  ...
  { scope: "MASTER_DATA", title: "Reset to master data only", phrase: "RESET MASTER DATA", details: "Deletes matchups, lineups, games, scores, voting activity, simulations, and checkpoints. Preserves player pool, teams, player team assignments, groups, divisions, and accounts." },
