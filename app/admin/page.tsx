...
export default async function Admin({ searchParams }: { searchParams: Promise<{ success?: string; error?: string }> }) {
  ...
  return <main className="admin-shell">
    ...
    <div className="mt-6 grid grid-cols-2 gap-3 md:gap-4 xl:grid-cols-4"><Quick href="#live-scoring" title="Live Scoring" text="Open active matches and encode points without page reloads."/><Quick href="/admin/tournament" title="Tournament Setup" text="Divisions, teams, lineup rules, court queue, and matchups."/><Quick href="/admin/players" title="Player Pool" text="Attendance, team assignment, and division eligibility."/><Quick href="/admin/voting" title="Voting" text="Fan Favorite voting codes and controls."/></div>
