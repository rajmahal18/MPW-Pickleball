...
export default async function GroupPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const qualificationByTeam = group.division.formatType === "GROUP_KNOCKOUT" ? qualificationOutcomes(tables, group.division.wildcardMode === "STANDARD" ? group.division.qualifiersPerGroup : 1, group.division.wildcardMode === "BATTLE" ? group.division.wildcardBattleSize : group.division.wildcardMode === "DIRECT" ? 1 : group.division.wildcardCount, { groupStageComplete: areGroupMatchupsComplete(allGroupMatchups), groupMatchups: allGroupMatchups }) : new Map();
